...
public class FunctionParserTest {
	...
	public void shouldParseFunction1() {
		...
		assertEquals(1, fn.evaluate(1., 2., 4.).size());
		assertEquals(1, fn.evaluate(1., 2., 4.).get(0), ACCURACY);
	}
    ...
    assertEquals(val * val, fn.evaluate(1., 2., 4.).get(0), ACCURACY);
	}
	...
	public void shouldParseFunction5() {
		...
		assertEquals(1, fn.evaluate(1., 2., 4.).size());
		assertEquals(0.5, fn.evaluate(1., 2., 4.).get(0), ACCURACY);
	}
	...
	public void shouldParseFunction6() {
		...
		assertEquals(1, fn.evaluate(1., 2., 4.).size());
		assertEquals(0.25, fn.evaluate(1., 2., 4.).get(0), ACCURACY);
	}
	...
	public void shouldParseFunction7() {
		...
		assertEquals(1, fn.evaluate(1., 2., 4.).size());
		assertEquals(1.12, fn.evaluate(1., 2., 4.).get(0), ACCURACY);
	}
	...
	public void shouldParseFunction8() {
		...
		assertEquals(1, fn.evaluate(1., 2., 4.).size());
		assertEquals(3.12, fn.evaluate(1., 2., 4.).get(0), ACCURACY);
	}
	...
	public void shouldParseFunction9() {
		...
		assertEquals(1, fn.evaluate(1., 2., 4.).size());
		assertEquals(Math.sin(4), fn.evaluate(1., 2., 4.).get(0), ACCURACY);
	}

	@Test
	public void shouldParseFunction10() {
		Function fn = parser.parseFunction("sqrt(t)");
		assertEquals(2, fn.evaluate(1., 2., 4.).size());
		assertEquals(2, fn.evaluate(1., 2., 4.).get(0), ACCURACY);
		assertEquals(-2, fn.evaluate(1., 2., 4.).get(1), ACCURACY);
	}
	...
	public void shouldParseFunction11() {
		...
		assertEquals(2, fn.evaluate(1., 2., 4.).size());
		assertEquals(0.5, fn.evaluate(1., 2., 4.).get(0), ACCURACY);
		assertEquals(-0.5, fn.evaluate(1., 2., 4.).get(1), ACCURACY);
	}
	...
	public void shouldParseFunction12() {
		...
		assertEquals(2, fn.evaluate(1., 2., 4.).size());
		assertEquals(4, fn.evaluate(1., 2., 4.).get(0), ACCURACY);
		assertEquals(0, fn.evaluate(1., 2., 4.).get(1), ACCURACY);
	}
	...
	public void shouldParseFunction13() {
		...
		assertEquals(1, fn.evaluate(1., 2., 4.).size());
		assertEquals(0, fn.evaluate(1., 2., 4.).get(0), ACCURACY);
	}
	...
	public void shouldParseFunction14() {
		...
		assertEquals(1, fn.evaluate(1., 2., 4.).size());
		assertEquals(6.189863256179242e14, fn.evaluate(1., 2., 4.).get(0), ACCURACY);
	}
	...
	public void shouldParseFunction15() {
		...
		assertEquals(1, fn.evaluate(1., 2., 4.).size());
		assertEquals(Double.POSITIVE_INFINITY, fn.evaluate(1., 2., 4.).get(0), ACCURACY);
	}
...
//	}
	...
	public void shouldParseFunction17() {
		...
		assertEquals(4, fn.evaluate(1., 2., 4.).size());
		assertEquals(1, fn.evaluate(1., 2., 4.).get(0), ACCURACY);
		assertEquals(-1, fn.evaluate(1., 2., 4.).get(1), ACCURACY);
		assertEquals(Double.NaN, fn.evaluate(1., 2., 4.).get(2), ACCURACY);
		assertEquals(Double.NaN, fn.evaluate(1., 2., 4.).get(3), ACCURACY);
	}
	...
	public void shouldParseFunction18() {
		...
		assertEquals(1, fn.evaluate(1., 2., 4.).size());
		assertEquals(Double.NaN, fn.evaluate(1., 2., 4.).get(0), ACCURACY);
	}
	...
	public void shouldParseFunction19() {
		...
		assertEquals(1, fn.evaluate(1., 2., 4.).size());
		assertEquals(7, fn.evaluate(1., 2., 4.).get(0), ACCURACY);
	}
	...
	public void shouldParseFunction20() {
		...
		assertEquals(1, fn.evaluate(1., 2., 4.).size());
		assertEquals(Math.exp(1), fn.evaluate(1., 2., 4.).get(0), ACCURACY);
	}
	...
	public void shouldParseFunction23() {
		...
		assertEquals(1, fn.evaluate(1., 2., 4.).size());
		assertEquals(512, fn.evaluate(1., 2., 4.).get(0), ACCURACY);
	}
}
