...
public class FunctionParserTest {
	...
	public void shouldParseFunctionRegardlessOfSpacesOrCase() {
		...
		assertEquals(1, fn.evaluate(new String[] {"x", "t"} , new double[] {1., 4.}).size());
		assertEquals(1, fn.evaluate(new String[] {"x", "t"} , new double[] {1., 4.}).get(0), ACCURACY);
	}

	@Test
	public void shouldParseFunctionRegardlessOfLetterUsed() {
		Function fn = parser.parseFunction("((sin((g+1)/h)) * (sin((g+1)/h))) + ((cos((g+1)/h)) * (cos((g+1)/h)))");
		assertEquals(1, fn.evaluate(new String[] {"g", "h"} , new double[] {1., 4.}).size());
		assertEquals(1, fn.evaluate(new String[] {"g", "h"} , new double[] {1., 4.}).get(0), ACCURACY);
	}

	@Test(expected = IllegalStateException.class)
	public void shouldThrowIllegalStateExceptionWhenEvaluatedWithoutParameterSpecified() {
		Function fn = parser.parseFunction("((sin((x+1)/t)) * (sin((x+1)/t))) + ((cos((x+1)/t)) * (cos((x+1)/t)))");
		fn.evaluate(new String[] {"x"} , new double[] {1.});
	}

	@Test(expected = IllegalStateException.class)
	public void shouldThrowIllegalStateExceptionWhenEvaluatedWithWrongNumberOfParameterSpecified() {
		Function fn = parser.parseFunction("((sin((x+1)/t)) * (sin((x+1)/t))) + ((cos((x+1)/t)) * (cos((x+1)/t)))");
		fn.evaluate(new String[] {"x", "t"} , new double[] {1.});
	}
    ...
    assertEquals(val * val, fn.evaluate(new String[] {"x", "t"} , new double[] {1., 4.}).get(0), ACCURACY);
	}
	...
	public void shouldParseFunction5() {
		...
		assertEquals(1, fn.evaluate(new String[] {"x", "t"} , new double[] {1., 4.}).size());
		assertEquals(0.5, fn.evaluate(new String[] {"x", "t"} , new double[] {1., 4.}).get(0), ACCURACY);
	}

	@Test
	public void shouldParseFunction6() {
		Function fn = parser.parseFunction("(y-1)/t");
		assertEquals(1, fn.evaluate(new String[] {"y", "t"} , new double[] {2., 4.}).size());
		assertEquals(0.25, fn.evaluate(new String[] {"y", "t"} , new double[] {2., 4.}).get(0), ACCURACY);
	}

	@Test
	public void shouldParseFunction7() {
		Function fn = parser.parseFunction("1.12*x");
		assertEquals(1, fn.evaluate(new String[] {"x"} , new double[] {1.}).size());
		assertEquals(1.12, fn.evaluate(new String[] {"x"} , new double[] {1.}).get(0), ACCURACY);
	}

	@Test
	public void shouldParseFunction8() {
		Function fn = parser.parseFunction("(1.12*x)+y");
		assertEquals(1, fn.evaluate(new String[] {"x", "y"} , new double[] {1., 2.}).size());
		assertEquals(3.12, fn.evaluate(new String[] {"x", "y"} , new double[] {1., 2.}).get(0), ACCURACY);
	}

	@Test
	public void shouldParseFunction9() {
		Function fn = parser.parseFunction("sin(t)");
		assertEquals(1, fn.evaluate(new String[] {"t"} , new double[] {4.}).size());
		assertEquals(Math.sin(4), fn.evaluate(new String[] {"t"} , new double[] {4.}).get(0), ACCURACY);
	}

	@Test
	public void shouldParseFunction10() {
		Function fn = parser.parseFunction("sqrt(t)");
		assertEquals(2, fn.evaluate(new String[] {"t"} , new double[] {4.}).size());
		assertEquals(2, fn.evaluate(new String[] {"t"} , new double[] {4.}).get(0), ACCURACY);
		assertEquals(-2, fn.evaluate(new String[] {"t"} , new double[] {4.}).get(1), ACCURACY);
	}
	...
	public void shouldParseFunction12() {
		...
		assertEquals(2, fn.evaluate().size());
		assertEquals(4, fn.evaluate().get(0), ACCURACY);
		assertEquals(0, fn.evaluate().get(1), ACCURACY);
	}

	@Test
	public void shouldParseFunction13() {
		Function fn = parser.parseFunction("0");
		assertEquals(1, fn.evaluate().size());
		assertEquals(0, fn.evaluate().get(0), ACCURACY);
	}
	...
	public void shouldParseFunction14() {
		...
		assertEquals(1, fn.evaluate().size());
		assertEquals(6.189863256179242e14, fn.evaluate().get(0), ACCURACY);
	}
	...
	public void shouldParseFunction15() {
		...
		assertEquals(1, fn.evaluate(new String[] {"x", "y"} , new double[] {1., 2.}).size());
		assertEquals(Double.POSITIVE_INFINITY, fn.evaluate(new String[] {"x", "y"} , new double[] {1., 2.}).get(0), ACCURACY);
	}
...
//	}
	...
	public void shouldParseFunction17() {
		...
		assertEquals(4, fn.evaluate(new String[] {"x"} , new double[] {1.}).size());
		assertEquals(1, fn.evaluate(new String[] {"x"} , new double[] {1.}).get(0), ACCURACY);
		assertEquals(-1, fn.evaluate(new String[] {"x"} , new double[] {1.}).get(1), ACCURACY);
		assertEquals(Double.NaN, fn.evaluate(new String[] {"x"} , new double[] {1.}).get(2), ACCURACY);
		assertEquals(Double.NaN, fn.evaluate(new String[] {"x"} , new double[] {1.}).get(3), ACCURACY);
	}
	...
	public void shouldParseFunction18() {
		...
		assertEquals(1, fn.evaluate().size());
		assertEquals(Double.NaN, fn.evaluate().get(0), ACCURACY);
	}
	...
	public void shouldParseFunction19() {
		...
		assertEquals(1, fn.evaluate().size());
		assertEquals(7, fn.evaluate().get(0), ACCURACY);
	}
	...
	public void shouldParseFunction20() {
		...
		assertEquals(1, fn.evaluate().size());
		assertEquals(Math.exp(1), fn.evaluate().get(0), ACCURACY);
	}
	...
	public void shouldParseFunction21() {
		...
		assertEquals(1, fn.evaluate().size());
		assertEquals(1, fn.evaluate().get(0), ACCURACY);
	}
	...
	public void shouldParseFunction23() {
		...
		assertEquals(1, fn.evaluate().size());
		assertEquals(512, fn.evaluate().get(0), ACCURACY);
	}
}
